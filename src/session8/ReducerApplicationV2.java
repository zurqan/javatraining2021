...
public class ReducerApplicationV2 {
...
//                                    v= new CopyOnWriteArrayList<>()
    ...
    //acc->elem->acc
    public static <E, A> A reduceL(CBiFunction<? super A, ? super E, ? extends A> accumulateFunction, A initial, E... array) {
        A result = initial;
        if (array == null) {
            return result;
        }
    ...
    //elem->acc->acc
    public static <E, A> A reduceR(CBiFunction<? super E, ? super A, ? extends A> accumulateFunction, A initial, E... array) {
        A result = initial;
        if (array == null) {
            return result;
        }
    ...
    public static void main(String[] args) {
        ...
        int s = ReducerApplicationV2.<Integer, Integer>advanceReduceL()
                .apply(sumInt)
                .apply(0)
                .apply(new Integer[]{1, 2, 3, 4, 5});


        Function<Integer[], Integer> sumOfArray = ReducerApplicationV2.<Integer, Integer>advanceReduceL()
                .apply(sumInt)
                .apply(0);

        Function<Integer[], Integer> productArray = ReducerApplicationV2.<Integer, Integer>advanceReduceL()
                .apply(intProduct)
                .apply(1);
